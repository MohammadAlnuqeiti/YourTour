            ...
            <form action="<?php echo e(route('admin.trips.store')); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" name="trip_name" placeholder="Enter name" value="<?php echo e(old('trip_name')); ?>" class="<?php $__errorArgs = ['trip_name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail11" name="short_description" placeholder="Enter Long description" value="<?php echo e(old('short_description')); ?>" class="<?php $__errorArgs = ['short_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail11" name="long_description" placeholder="Enter Long description" value="<?php echo e(old('long_description')); ?>" class="<?php $__errorArgs = ['long_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" name="guest_number" placeholder="Enter guest number" value="<?php echo e(old('guest_number')); ?>" class="<?php $__errorArgs = ['guest_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputEmail1" name="trip_price" placeholder="Enter price" value="<?php echo e(old('trip_price')); ?>" class="<?php $__errorArgs = ['trip_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select rounded-0" id="exampleSelectRounded0" name="select" class="<?php $__errorArgs = ['select'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="trip_image" value="<?php echo e(old('trip_image')); ?>" class="<?php $__errorArgs = ['trip_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="trip_image2" value="<?php echo e(old('trip_image2')); ?>" class="<?php $__errorArgs = ['trip_image2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);

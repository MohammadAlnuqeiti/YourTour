        ...
        <div class="row g-5" style="justify-content: center;">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="row g-2 pt-2">
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer1.png" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer2.png" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer3.png" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer4.png" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer5.png" alt="">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid bg-light p-1" src="/users/img/footer6.png" alt="">
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\yourTour\resources\views/publicUser/footer.blade.php ENDPATH**/ ?>